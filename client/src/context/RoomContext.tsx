import { createContext, useEffect, useState, useReducer, PropsWithChildren } from "react";
...
import { peersReducer, PeerState, PeerAction } from "./peerReducer";
import { addPeerAction, removePeerAction } from "./peerActions/peerActions";
...
export const RoomProvider: React.FunctionComponent<PropsWithChildren> = ({ children }) => {
    ...
    useEffect(() => {
        ...
        me.on("connection", (conn) => {
            ...
            // Ensure videoTrack is defined before calling replaceTrack
            if (videoTrack) {
                conn.peerConnection
                    .getSenders()[1]
                    .replaceTrack(videoTrack)
